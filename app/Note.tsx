      ...
      <DialogTrigger asChild>
        ...
        >
          {note?.title && (
            <CardHeader>
              <CardTitle>
                <h4 className="break-all overflow-auto font-semibold text-lg">
                  {note?.title}
                </h4>
              </CardTitle>
            </CardHeader>
      ...
      >
        <div className="overflow-auto">
          <Input
            type="text"
            placeholder="Title"
            className="border-none focus-visible:ring-0 focus-visible:outline-none font-bold text-lg py-6"
            value={title}
            onChange={(e) => {
          ...
          <p className="text-muted-foreground text-xs italic mt-1 ">
            Last modified: {format(note?.updated_at || null, "PPp")}
          </p>
        </div>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent size="sm">
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This action cannot be undone. This will delete this note
                  permanently.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
